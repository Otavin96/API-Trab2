...
export class CreateDatabase1744249475017 implements MigrationInterface {
    name = 'CreateDatabase1744249475017'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."clients_roles_enum" AS ENUM('admin', 'client')`);
        await queryRunner.query(`CREATE TABLE "clients" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "cnpj" text NOT NULL, "social_reason" text NOT NULL, "email" text NOT NULL, "password" text NOT NULL, "phone" text NOT NULL, "roles" "public"."clients_roles_enum" NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_f1ab7cf3a5714dbc6bb4e1c28a4" PRIMARY KEY ("id"))`);
